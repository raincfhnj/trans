...
// CharOffset is how wide the writing in front of the cursor is, in cells: the
// cursor's place on screen, which an input method has to be told.
func (m Model) CharOffset() int { return m.area.LineInfo().CharOffset }
